...
import indi.github.icear.simpleclass.data.academicdata.util.ClassConvertUtil;
...
class ClassInfoRecyclerViewAdapter extends RecyclerView.Adapter<ClassInfoRecyclerViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(indi.github.icear.simpleclass.R.layout.item_classinfo, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mTextViewWeeks.setText(
                SimpleClassApplication.getApplication()
                        .getString(indi.github.icear.simpleclass.R.string.weekCount,
        ...
        holder.mTextViewTime.setText(DateUtil.formatWeek(mValue.get(position).getWeekDay()) + " " +
                SimpleClassApplication.getApplication().getString(indi.github.icear.simpleclass.R.string.classSection, mValue.get(position).getSection()));
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            super(view);
            mTextViewWeeks = (TextView) view.findViewById(indi.github.icear.simpleclass.R.id.textView_weeks);
            mTextViewLocation = (TextView) view.findViewById(indi.github.icear.simpleclass.R.id.textView_location);
            mTextViewTime = (TextView) view.findViewById(indi.github.icear.simpleclass.R.id.textView_time);
        }
